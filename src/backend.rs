...
struct Profile {
    ...
    font_size: u8, // 1rem, number is pixel value
    message_spacing: u8, 
    ...
    input_volume: i8,  // decibels
    output_volume: f64, // multiplier, e.g., 2 is twie as loud, etc. 
    ...
    attenuation: i8, // Lower the volume of other applications when someone is speaking. 0 disables  it. Unit: Debibels
    ...
    emoji_prefered_gender: String, // "person", "womman", "man" -- edits the shortcode, when you just do :shrug: it will append yourPrefrence_ to make it represent you better
    ...
    mobile_notification_timeout: i8, 
    ...
    //#
    language: String, // ISO codes, e.g., en-US, da, etc. 
    ...
    developer_mode: bool, // Show more items in the context menu such as copy ID
